...
```
 ...
 - Between 2009-20014, there was an increase in the number of primary school graduates who married for the first time, but after 2014 this number started to decrease. The number of male who married for the first time has increased from 2009 to 2018, but there has been a decline in the last year.
...
- When we examine the table below, it has been observed that the average number of first marriage of women and men who graduated from high school or equivalent vocational school has increased between 2009 and 2014, and a significant decrease is observed in the rate of first marriage of men and women in the period after 2015. When the educational status data are examined in general, especially the number of first marriage of high school and equivalent school graduates is higher than the others when compared with other education levels.
...
```
 ...
 - There is a fluctuation over the years in the number of first marriages of women who are literate but have not graduated from any school. The year 2014 was the year when women in this education category got married the most, and there was a dramatic decrease in the rate of first marriage among women between 2015 and 2019. In the table, the average number of first marriage of men who are literate but do not graduate from any school is quite low compared to women, and a clear decrease has been observed after 2015.
...
```
 ...
 - When we look at the graph below, the number of people who are illiterate and married for the first time is quite low, and it has been decreasing for both genders from 2009 to 2019. If we compare both sexes within themselves, the number of women who married for the first time without being illiterate is more than men.
...
```
 ...
 - The education level with the lowest average number of marriages between 2009-20014 is Ortaokul Veya Dengi Meslek Ortaokul Education Level. The number of people married for the first time at this educational level is increasing for women and for men, it increased in 2015, then decreased until 2018 and reached its highest level in 2019.
...
```
 ...
 - When we analyzed in the table below, there is a clear decrease in the average number of first marriages between 2009 and 2019 for men and women whose educational status is unknown, and the rates of first marriage for men and women between 2015 and 2019 are very close to each other.
